<div id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<header class="top-header">
		<nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
				<a class="navbar-brand" href="index.html"><img src="/assets/ZION/logo.png" class="logo_image" alt="image"></a>
	...
	<div class="home-slider">
		<ul class="rslides">
			<li><img src="/assets/images/slider-01.jpg" alt=""></li>
			<li><img src="/assets/images/slider-02.jpg" alt=""></li>
			<li><img src="/assets/images/slider-03.jpg" alt=""></li>
		</ul>
		<div class="lbox-details">
			<h1>Zion House of Prayer</h1>
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="row align-items-center about-main-info">
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="about-m">
									<div class="about-img">
										<img class="img-fluid" src="/assets/images/about-img-01.jpg" alt="" />
									</div>
									<ul>
						...
						<div class="row align-items-center about-main-info">
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="about-m">
									<div class="about-img">
										<img class="img-fluid" src="/assets/images/about-img-02.jpg" alt="" />
									</div>
									<ul>
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
		...
		<div class="container">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" >
							<div class="caption">
								...
								<div class="image">
									...
									<div class="title">
										<h2>Every Monday<i class="fa fa-angle-right" aria-hidden="true"></i></h2>
									</div>
								</div>
								<div class="textContent">
									<p class="lead">Chain Prayer</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
							<div class="caption">
								...
								<div class="image">
									...
									<div class="title">
										<h2>Every Tuesday<i class="fa fa-angle-right" aria-hidden="true"></i></h2>
									</div>
								</div>
								<div class="textContent">
									<p class="lead">Womens Ministry</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
							<div class="caption">
								...
								<div class="image">
									...
									<div class="title">
										<h2>Every Wednesday <i class="fa fa-angle-right" aria-hidden="true"></i></h2>
									</div>
								</div>
								<div class="textContent">
									<p class="lead">Church Prayer</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
							<div class="caption">
								...
								<div class="image">
									...
									<div class="title">
										<h2>Every Thursday <i class="fa fa-angle-right" aria-hidden="true"></i></h2>
									</div>
								</div>
								<div class="textContent">
									<p class="lead">Bible Study</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
							<div class="caption">
								...
								<div class="image">
									...
									<div class="title">
										<h2>Every Friday<i class="fa fa-angle-right" aria-hidden="true"></i></h2>
									</div>
								</div>
								<div class="textContent">
									<p class="lead">Gospel Retreat</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
							<div class="caption">
								...
								<div class="image">
									<img src="images/time-05.jpg" alt="" />
									<div class="title">
										<h2>Every Saturday<i class="fa fa-angle-right" aria-hidden="true"></i></h2>
									</div>
								</div>
								<div class="textContent">
									<p class="lead">Fasting Prayers</p>
								</div>
							</div>
						</div>
				</div>
			...
			<div class="timeLine">
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item1">
						<div class="caption">
							<div class="star center-block" id="date1"></div>
							<div class="image">
								<img src="/assets/ZION/chainprayer.jpg" alt="" />
								<div class="title">
									<h2>Every <span id="day1"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Chain Prayer</p>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item2">
						<div class="caption">
							<div class="star center-block" id="date2"></div>
							<div class="image">
								<img src="/assets/ZION/womensmeeting.jpeg" alt="" />
								<div class="title">
									<h2>Every <span id="day2"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Women's Ministry</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item3">
						<div class="caption">
							<div class="star center-block" id="date3">
								</div>
							<div class="image">
								<img src="/assets/ZION/logo.png" alt="" />
								<div class="title">
									<h2>Every <span id="day3"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Church Prayer</p>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item4">
						<div class="caption">
							<div class="star center-block" id="date4">
							</div>
							<div class="image">
								<img src="/assets/images/time-04.jpg" alt="" />
								<div class="title">
									<h2>Every <span id="day4"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Bible Study</p>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item5">
						<div class="caption">
							<div class="star center-block" id="date5"></div>
							<div class="image">
								<img src="/assets/ZION/chainprayer.jpg" alt="" />
								<div class="title">
									<h2>Every <span id="day5"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Gospel Retreat</p>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item6">
						<div class="caption">
							<div class="star center-block" id="date6"></div>
							<div class="image">
								<img src="/assets/ZION/gospelmeeting.jpeg" alt="" />
								<div class="title">
									<h2>Every <span id="day6"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Fasting Prayers</p>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" id="item7">
						<div class="caption">
							<div class="star center-block" id="date7"></div>
							<div class="image">
								<img src="/assets/ZION/fastingprayer.jpeg" alt="" />
								<div class="title">
									<h2>Every <span id="day7"></span><i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
							<div class="textContent">
								<p class="lead">Fasting Prayers</p>
				...
				<ul class="popup-gallery clearfix">
					<li>
						<a href="/assets/images/gallery-01.jpg">
							<img class="img-fluid" src="/assets/images/gallery-01.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-02.jpg">
							<img class="img-fluid" src="/assets/images/gallery-02.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-03.jpg">
							<img class="img-fluid" src="/assets/images/gallery-03.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-04.jpg">
							<img class="img-fluid" src="/assets/images/gallery-04.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-05.jpg">
							<img class="img-fluid" src="/assets/images/gallery-05.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-06.jpg">
							<img class="img-fluid" src="/assets/images/gallery-06.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-07.jpg">
							<img class="img-fluid" src="/assets/images/gallery-07.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
					<li>
						<a href="/assets/images/gallery-08.jpg">
							<img class="img-fluid" src="/assets/images/gallery-08.jpg" alt="single image">
							<span class="overlay"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
						</a>
					</li>
				</ul>
